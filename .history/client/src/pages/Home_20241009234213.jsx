...
const Home = () => {
	...
	const getData = () => {
		axios.get('https://mern-crud-server-lyart.vercel.app/employees')
            .then(res => {
	...
	const handleEdit = (id) => {
		handleShow();
		axios.get(`https://mern-crud-server-lyart.vercel.app/employees/${id}`).then((res) => {
			setEditID(id);
	...
	const handleDelete = (id) => {
		if (window.confirm('Are you sure you want to delete this record?')) {
			const url = `https://mern-crud-server-lyart.vercel.app/employees/${id}`;
	...
	const handleUpdate = () => {
		const url = `https://mern-crud-server-lyart.vercel.app/employees/${editID}`;
		const updatedData = {
	...
	const handleSave = () => {
		const url = 'https://mern-crud-server-lyart.vercel.app/employees';
		const data = {
			"employee_name": name,
			"employee_age": age,
